...
async fn list_tools() -> impl IntoResponse {
    let tools = vec![
        tool_def("search_missions", "Search missions by name or tag", json!({"type":"object","properties":{"query":{"type":"string"}}})),
        ...
        tool_def("create_doc", "Create a doc in a mission", json!({"type":"object","properties":{"mission_id":{"type":"string"},"title":{"type":"string"},"body":{"type":"string"},"doc_type":{"type":"string"},"status":{"type":"string"},"provenance":{"type":"string"}}})),
        tool_def("create_artifact", "Create an artifact in a mission", json!({"type":"object","properties":{"mission_id":{"type":"string"},"name":{"type":"string"},"artifact_type":{"type":"string"},"uri":{"type":"string"},"content_b64":{"type":"string"},"storage_backend":{"type":"string"},"storage_class":{"type":"string"},"content_sha256":{"type":"string"},"size_bytes":{"type":"integer"},"mime_type":{"type":"string"},"external_pointer":{"type":"boolean"},"external_uri":{"type":"string"},"status":{"type":"string"},"provenance":{"type":"string"}}})),
        ...
        tool_def("create_task", "Create a task in a mission", json!({"type":"object","properties":{"mission_id":{"type":"string"},"title":{"type":"string"},"description":{"type":"string"},"owner":{"type":"string"}}})),
        ...
        tool_def("list_tasks", "List tasks for a mission", json!({"type":"object","properties":{"mission_id":{"type":"string"}}})),
        tool_def("list_pending_ledger_events", "List pending ledger events (default domain-scoped)", json!({"type":"object","properties":{"domain_id":{"type":"string"},"limit":{"type":"integer"}}})),
        ...
        tool_def("get_entity_history", "Get ledger event history for an entity", json!({"type":"object","properties":{"entity_type":{"type":"string"},"entity_id":{"type":"string"},"domain_id":{"type":"string"}}})),
        tool_def("create_domain", "Create a domain", json!({"type":"object","properties":{"name":{"type":"string"},"description":{"type":"string"}}})),
        tool_def("list_domains", "List domains readable by current principal", json!({"type":"object","properties":{"limit":{"type":"integer"}}})),
        tool_def("create_mission", "Create a mission in a domain", json!({"type":"object","properties":{"domain_id":{"type":"string"},"name":{"type":"string"},"description":{"type":"string"}}})),
        ...
        tool_def("update_domain", "Update a domain by id", json!({"type":"object","properties":{"domain_id":{"type":"string"},"name":{"type":"string"},"description":{"type":"string"},"status":{"type":"string"}}})),
        tool_def("delete_domain", "Delete a domain by id", json!({"type":"object","properties":{"domain_id":{"type":"string"}}})),
        ...
        tool_def("list_agents", "List registered agents", json!({"type":"object","properties":{"domain_id":{"type":"string"}}})),
        ...
        tool_def("list_task_assignments", "List task assignments", json!({"type":"object","properties":{"agent_id":{"type":"string"},"mission_id":{"type":"string"}}})),
        tool_def("resolve_skill_snapshot", "Resolve effective domain+mission skill snapshot", json!({"type":"object","properties":{"domain_id":{"type":"string"},"mission_id":{"type":"string"}}})),
        tool_def("download_skill_snapshot", "Download a resolved skill snapshot tarball", json!({"type":"object","properties":{"domain_id":{"type":"string"},"mission_id":{"type":"string"}}})),
        tool_def("get_skill_sync_status", "Read last recorded local skill sync state", json!({"type":"object","properties":{"domain_id":{"type":"string"},"mission_id":{"type":"string"}}})),
        tool_def("ack_skill_sync", "Record local sync/apply status for domain/mission skill snapshot", json!({"type":"object","properties":{"domain_id":{"type":"string"},"mission_id":{"type":"string"},"snapshot_id":{"type":"string"},"sha256":{"type":"string"}}})),
        tool_def("promote_local_skill_overlay", "Mark local overlay as promoted for current domain/mission state", json!({"type":"object","properties":{"domain_id":{"type":"string"},"mission_id":{"type":"string"}}})),
        ...
        tool_def("create_remote_launch", "Launch an agent process on a registered remote target", json!({"type":"object","properties":{"target_id":{"type":"string"},"domain_id":{"type":"string"},"mission_id":{"type":"string"},"runtime_kind":{"type":"string"},"prompt":{"type":"string"}}})),
        ...
        tool_def("enroll_mesh_agent", "Enroll an agent in a domain (mesh work model)", json!({"type":"object","properties":{"domain_id":{"type":"string"},"agent_id":{"type":"string"},"capabilities_json":{"type":"string"},"runtime_kind":{"type":"string"},"agent_name":{"type":"string","description":"Optional canonical agent identity name — links this enrollment to an agent row and exposes its public_id as the wire identifier."}}})),
        tool_def("list_mesh_agents", "List agents enrolled in a domain", json!({"type":"object","properties":{"domain_id":{"type":"string"}}})),
        ...
        tool_def("list_domain_packs", "List domain packs owned by the current principal", json!({"type":"object","properties":{"limit":{"type":"integer"}}})),
        tool_def("export_domain_pack", "Export a domain into a portable domain pack tarball", json!({"type":"object","properties":{"domain_id":{"type":"string"},"name":{"type":"string"}}})),
        tool_def("install_domain_pack", "Install a domain pack, creating domain + missions + skills + budgets", json!({"type":"object","properties":{"pack_id":{"type":"string"},"name_override":{"type":"string"}}})),
    ];
    Json(tools)
}
...
async fn dispatch(
    ...
    match tool {
        ...
        "create_task" => {
            ...
            match sqlx::query(
                "INSERT INTO task (mission_id, title, description, owner, status, created_at, updated_at) \
            ...
            .await
            {
                Ok(row) => {
                    ...
                    ok_result(json!({"id": id, "mission_id": mission_id, "title": title, "description": description, "owner": owner, "status": "proposed"}))
                }
                Err(e) => {
        ...
        "list_tasks" => {
            ...
            match sqlx::query(
                "SELECT id, mission_id, title, description, status, owner, created_at, updated_at \
                 FROM task WHERE mission_id=$1 ORDER BY created_at DESC LIMIT 200",
            )
            .bind(&mission_id)
            .fetch_all(&state.db)
            .await
        ...
        "create_domain" => {
            ...
            .execute(&state.db).await
            {
                ...
                Err(e) => { tracing::error!("mcp create_domain: {e}"); err_result("database_error") }
            }
        }
        ...
        "list_domains" => {
            ...
            .await
            {
                ...
                Err(e) => { tracing::error!("mcp list_domains: {e}"); err_result("database_error") }
            }
        }
        ...
        "update_domain" => {
            ...
            if description.is_some() { parts.push(format!("description = ${}", parts.len() + 2)); }
            if status.is_some() { parts.push(format!("status = ${}", parts.len() + 2)); }
            let sql = format!("UPDATE domain SET {} WHERE id=$1", parts.join(", "));
            let mut q = sqlx::query(&sql).bind(&domain_id);
            if let Some(v) = name { q = q.bind(v); }
            if let Some(v) = description { q = q.bind(v); }
            if let Some(v) = status { q = q.bind(v); }
            match q.execute(&state.db).await {
                Ok(r) if r.rows_affected() == 0 => err_result("domain_not_found"),
                Ok(_) => ok_result(json!({"id": domain_id, "updated": true})),
                Err(e) => { tracing::error!("mcp update_domain: {e}"); err_result("database_error") }
            }
        }
        ...
        "delete_domain" => {
            let domain_id = str_arg(args, "domain_id");
            if domain_id.is_empty() { return err_result("domain_id is required"); }
            match sqlx::query("DELETE FROM domain WHERE id=$1")
                .bind(&domain_id).execute(&state.db).await
            {
                Ok(r) if r.rows_affected() == 0 => err_result("domain_not_found"),
                Ok(_) => ok_result(json!({"deleted": true})),
                Err(e) => { tracing::error!("mcp delete_domain: {e}"); err_result("database_error") }
            }
        }
        ...
        "read_doc" => {
            ...
            match sqlx::query(
                "SELECT id, mission_id, title, body, doc_type, status, provenance, created_at, updated_at FROM doc WHERE id=$1"
            )
            .bind(doc_id as i32)
            .fetch_optional(&state.db)
            .await
        ...
        "create_doc" => {
            let mission_id = str_arg(args, "mission_id");
            let title = str_arg(args, "title");
            if mission_id.is_empty() || title.is_empty() { return err_result("mission_id and title are required"); }
            ...
            match sqlx::query(
                "INSERT INTO doc (mission_id, title, body, doc_type, status, provenance, created_at, updated_at) \
                 VALUES ($1,$2,$3,$4,$5,$6,$7,$7) RETURNING id"
            )
            .bind(&mission_id).bind(&title).bind(&body).bind(&doc_type).bind(&status).bind(&provenance).bind(now)
            .fetch_one(&state.db).await
            {
                Ok(r) => ok_result(json!({"id": r.get::<i32,_>("id"), "mission_id": mission_id, "title": title, "status": status})),
        ...
        "register_agent" => {
            ...
            // `edgeplane agent signal`) skip a follow-up GET /agents/{name} round-trip.
        ...
        // ── Missions search (name-based fallback, no vectorstore) ─────────────

        "search_missions" => {
            let query = str_arg(args, "query");
            match sqlx::query(
                "SELECT id, domain_id, name, description, status FROM mission \
            ...
            .fetch_all(&state.db).await
            {
                ...
                Err(e) => { tracing::error!("mcp search_missions: {e}"); err_result("database_error") }
            }
        }
        ...
        "search_tasks" => {
            ...
            match sqlx::query(
                "SELECT id, mission_id, title, description, status, owner FROM task \
        ...
        "create_artifact" => {
            ...
            match sqlx::query(
                "INSERT INTO artifact (mission_id, name, artifact_type, uri, status, mime_type, size_bytes, \
                 external_pointer, created_at, updated_at) VALUES ($1,$2,$3,$4,$5,$6,$7,false,$8,$8) RETURNING id"
            )
            .bind(&mission_id).bind(&name).bind(&artifact_type).bind(&uri).bind(&status)
            .bind(&mime_type).bind(size_bytes as i64).bind(now)
            .fetch_one(&state.db).await
            {
                Ok(r) => ok_result(json!({"id": r.get::<i32,_>("id"), "mission_id": mission_id, "name": name, "status": status})),
            ...
            match sqlx::query(
                "SELECT ta.id, ta.task_id, ta.agent_id, ta.status, ta.created_at, ta.updated_at \
                 ...
                 WHERE ($1::bigint IS NULL OR ta.agent_id = $1) \
                   AND ($2::text IS NULL OR t.mission_id = $2) \
                 ORDER BY ta.updated_at DESC LIMIT $3"
            )
            .bind(agent_id).bind(mission_id).bind(limit)
            .fetch_all(&state.db).await
            {
                Ok(rows) => ok_result(Value::Array(rows.iter().map(|r| json!({
                    "id": r.get::<i32,_>("id"),
        ...
        "enroll_mesh_agent" => {
            ...
            // edgeplaned uses for `/agents/{public_id}/messages`.
            ...
            match sqlx::query(
                "INSERT INTO meshagent (id, domain_id, runtime_kind, capabilities, status, enrolled_by_subject, enrolled_at, agent_public_id) \
                 VALUES ($1,$2,$3,$4,'offline',$5,NOW(),$6) \
                 ON CONFLICT (id) DO UPDATE SET domain_id=$2, status='offline', enrolled_at=NOW(), \
                    agent_public_id=COALESCE(EXCLUDED.agent_public_id, meshagent.agent_public_id) \
                 RETURNING id, agent_public_id"
            )
            .bind(&id).bind(&domain_id).bind(&runtime_kind).bind(capabilities).bind(&principal.subject).bind(&agent_public_id)
            .fetch_one(&state.db).await
            {
                Ok(r) => ok_result(json!({
        ...
        "list_mesh_agents" => {
            ...
            if domain_id.is_empty() { return err_result("domain_id is required"); }
            match sqlx::query(
                "SELECT id, domain_id, runtime_kind, status, capabilities, enrolled_at, last_heartbeat_at \
                 FROM meshagent WHERE domain_id=$1 ORDER BY enrolled_at DESC LIMIT 100"
            )
        ...
        "list_pending_ledger_events" => {
            ...
            let rows = if domain_id.is_empty() {
                ...
                sqlx::query("SELECT * FROM ledgerevent WHERE state='pending' AND domain_id=$1 ORDER BY created_at ASC LIMIT $2")
        ...
        "get_entity_history" => {
            ...
            let rows = if domain_id.is_empty() {
                ...
                sqlx::query("SELECT * FROM ledgerevent WHERE domain_id=$1 AND entity_type=$2 AND entity_id=$3 ORDER BY created_at DESC LIMIT $4")
                    .bind(&domain_id).bind(&entity_type).bind(&entity_id).bind(limit).fetch_all(&state.db).await
            };
            match rows {
                Ok(rows) => ok_result(json!(rows.iter().map(|r| json!({
                    "id": r.get::<i32,_>("id"),
        ...
        "get_skill_sync_status" => {
            ...
            if domain_id.is_empty() { return err_result("domain_id is required"); }
            let row = sqlx::query(
                "SELECT * FROM skilllocalstate WHERE actor_subject=$1 AND domain_id=$2 \
                 AND ($3='' OR mission_id=$3) AND ($4='' OR agent_id=$4) LIMIT 1"
            )
            .bind(&principal.subject).bind(&domain_id).bind(&mission_id).bind(&agent_id)
            .fetch_optional(&state.db).await;
            match row {
                Ok(Some(r)) => ok_result(json!({
                    "domain_id": r.get::<String,_>("domain_id"),
                ...
                Ok(None) => ok_result(json!({"domain_id": domain_id, "status": "no_record"})),
        ...
        "ack_skill_sync" => {
            ...
            if domain_id.is_empty() || mission_id.is_empty() {
                return err_result("domain_id and mission_id are required");
            }
            let result = sqlx::query(
                "INSERT INTO skilllocalstate \
                 (actor_subject, domain_id, mission_id, agent_id, last_snapshot_id, last_snapshot_sha256, \
            ...
            .bind(&principal.subject).bind(&domain_id).bind(&mission_id)
        ...
        "promote_local_skill_overlay" => {
            ...
            if domain_id.is_empty() || mission_id.is_empty() || sha256.is_empty() {
                return err_result("domain_id, mission_id, local_overlay_sha256 are required");
            }
            let drift_details = json!({"promoted": true, "note": note}).to_string();
            let result = sqlx::query(
                "INSERT INTO skilllocalstate \
                 (actor_subject, domain_id, mission_id, agent_id, local_overlay_sha256, drift_details, last_sync_at) \
        ...
        // ── Domain packs (list only; export/install need Python) ─────────────

        "list_domain_packs" => {
            let limit = int_arg(args, "limit").unwrap_or(50).min(200);
            let rows = sqlx::query(
                "SELECT id, name, version, sha256, created_at FROM domainpack \
            ...
            match rows {
                ...
                Err(e) => { tracing::error!("mcp list_domain_packs: {e}"); err_result("database_error") }
            }
        }
        ...
        "resolve_skill_snapshot" => {
            ...
            let mission_id = str_arg(args, "mission_id");
            if domain_id.is_empty() { return err_result("domain_id is required"); }
            // Try mission-specific first, then fall back to domain-level
            let row = if !mission_id.is_empty() {
                let r = sqlx::query(
                    "SELECT * FROM skillsnapshot WHERE domain_id=$1 AND mission_id=$2 \
                     ORDER BY created_at DESC LIMIT 1"
                )
                .bind(&domain_id).bind(&mission_id)
                .fetch_optional(&state.db).await;
                match r {
                    Ok(Some(r)) => Some(r),
                    Ok(None) => sqlx::query(
                        "SELECT * FROM skillsnapshot WHERE domain_id=$1 AND mission_id='' \
                         ORDER BY created_at DESC LIMIT 1"
                    )
                    .bind(&domain_id).fetch_optional(&state.db).await.unwrap_or(None),
            ...
            match row {
                Some(r) => {
                    ...
                    ok_result(json!({"snapshot": {
                        ...
                        "domain_bundle_id": r.get::<String,_>("domain_bundle_id"),
        ...
        "export_domain_pack" => {
            ...
            let domain = sqlx::query("SELECT * FROM domain WHERE id=$1")
                .bind(&domain_id).fetch_optional(&state.db).await;
            let domain = match domain {
                Ok(Some(r)) => r,
                Ok(None) => return err_result("domain not found"),
                Err(e) => { tracing::error!("mcp export_domain_pack: {e}"); return err_result("database_error"); }
            };

            let missions = sqlx::query("SELECT * FROM mission WHERE domain_id=$1")
                .bind(&domain_id).fetch_all(&state.db).await.unwrap_or_default();
            let skill_bundles = sqlx::query(
                "SELECT * FROM skillbundle WHERE scope_type='domain' AND scope_id=$1"
            )
            .bind(&domain_id).fetch_all(&state.db).await.unwrap_or_default();
            let budget_policies = sqlx::query(
                "SELECT * FROM budgetpolicy WHERE scope_type='domain' AND scope_id=$1 \
                 AND owner_subject=$2 AND active=true"
            )
            .bind(&domain_id).bind(&principal.subject)
            ...
            let domain_name: String = domain.get("name");
            let domain_desc: String = domain.try_get("description").unwrap_or_default();
            ...
            if let Err(e) = add_json_entry(&mut tar, "domain.json", &json!({
                "id": domain_id, "name": domain_name, "description": domain_desc,
            })) { tracing::error!("mcp export tar domain.json: {e}"); return err_result("tar_error"); }

            for k in &missions {
                let kid: String = k.get("id");
                let kname: String = k.get("name");
                let kdesc: String = k.try_get("description").unwrap_or_default();
                let path = format!("missions/{kid}.json");
            ...
            .bind(&pack_id).bind(&principal.subject).bind(&domain_name)
            ...
            .fetch_one(&state.db).await {
                ...
                Err(e) => { tracing::error!("mcp export_domain_pack insert: {e}"); err_result("database_error") }
            }
        }
        ...
        "install_domain_pack" => {
            ...
            let target_domain_id = str_arg(args, "target_domain_id");

            let pack_row = sqlx::query(
                "SELECT * FROM domainpack WHERE id=$1 AND owner_subject=$2"
            )
            ...
            let pack_row = match pack_row {
                ...
                Err(e) => { tracing::error!("mcp install_domain_pack: {e}"); return err_result("database_error"); }
            };
            ...
            let entries: Vec<(String, Vec<u8>)> = match archive.entries() {
                ...
                Err(e) => { tracing::error!("mcp install_domain_pack tar: {e}"); return err_result("pack tarball is corrupt"); }
            };

            // Parse manifest + domain
            let manifest: serde_json::Value = entries.iter()
                .find(|(n,_)| n == "manifest.json")
                .and_then(|(_,b)| serde_json::from_slice(b).ok())
                .unwrap_or(json!({}));
            let domain_spec: serde_json::Value = entries.iter()
                .find(|(n,_)| n == "domain.json")
                .and_then(|(_,b)| serde_json::from_slice(b).ok())
                .unwrap_or(json!({}));
            ...
            let domain_id = if !target_domain_id.is_empty() {
                let exists: Option<i64> = sqlx::query_scalar("SELECT 1 FROM domain WHERE id=$1")
                    .bind(&target_domain_id).fetch_optional(&state.db).await.unwrap_or(None);
                if exists.is_none() { return err_result("target domain not found"); }
                target_domain_id.clone()
            } else {
                let new_id = uuid::Uuid::new_v4().to_string();
                let pack_name: String = pack_row.get("name");
                let domain_name = format!("{pack_name} (from pack)");
                let desc = domain_spec.get("description").and_then(|v| v.as_str()).unwrap_or("");
                sqlx::query(
                    "INSERT INTO domain (id, owners, name, description, created_at, updated_at) \
                     VALUES ($1,$2,$3,$4,$5,$5)"
                )
                .bind(&new_id).bind(&principal.subject).bind(&domain_name)
                .bind(desc).bind(now)
                .execute(&state.db).await
                .map_err(|e| tracing::error!("mcp install domain create: {e}")).ok();
                created_domains.push(new_id.clone());
                new_id
            };

            // Insert missions
            for (name, body) in entries.iter().filter(|(n,_)| n.starts_with("missions/") && n.ends_with(".json")) {
                ...
                let exists: Option<String> = sqlx::query_scalar(
                    "SELECT id FROM mission WHERE domain_id=$1 AND name=$2"
                )
                .bind(&domain_id).bind(kname).fetch_optional(&state.db).await.unwrap_or(None);
                if exists.is_none() {
                    let kid = uuid::Uuid::new_v4().to_string();
                    let kdesc = spec.get("description").and_then(|v| v.as_str()).unwrap_or("");
                    let _ = sqlx::query(
                        "INSERT INTO mission (id, domain_id, name, description, owners, created_at, updated_at) \
                         VALUES ($1,$2,$3,$4,$5,$6,$6)"
                    )
                    .bind(&kid).bind(&domain_id).bind(kname).bind(kdesc)
                    .bind(&principal.subject).bind(now)
                    .execute(&state.db).await;
                    created_missions.push(kid);
                }
            ...
            for (name, body) in entries.iter().filter(|(n,_)| n.starts_with("skills/") && n.ends_with(".json")) {
                ...
                let exists: Option<String> = sqlx::query_scalar(
                    "SELECT id FROM skillbundle WHERE scope_type='domain' AND scope_id=$1 AND sha256=$2"
                )
                .bind(&domain_id).bind(sha).fetch_optional(&state.db).await.unwrap_or(None);
                if exists.is_none() {
                    ...
                    let _ = sqlx::query(
                        "INSERT INTO skillbundle (id, scope_type, scope_id, domain_id, version, tarball_b64, sha256, created_at, updated_at) \
                         VALUES ($1,'domain',$2,$2,$3,$4,$5,$6,$6)"
                    )
                    .bind(&sbid).bind(&domain_id).bind(ver).bind(tarball).bind(sha).bind(now)
                    .execute(&state.db).await;
            ...
            for (name, body) in entries.iter().filter(|(n,_)| n.starts_with("budgets/") && n.ends_with(".json")) {
                ...
                let _ = sqlx::query(
                    "INSERT INTO budgetpolicy (id, owner_subject, scope_type, scope_id, window_type, \
                     ...
                     VALUES ($1,$2,'domain',$3,$4,$5,$6,$7,true,$8,$8)"
                )
                .bind(&bpid).bind(&principal.subject).bind(&domain_id)
            ...
            ok_result(json!({
                "pack_id": pack_id,
                "domain_id": domain_id,
                "created": {"domains": created_domains, "missions": created_missions, "skills": created_skills, "budgets": created_budgets},
                "manifest": manifest,
            }))
        }
...
async fn issue_mcp_session(
    ...
    let session_id: i32 = sqlx::query_scalar(
        "INSERT INTO usersession \
         ...
         VALUES ($1,$2,$3,$4,$5,$5,'edgeplane-mcp',false,$6) RETURNING id",
    )
