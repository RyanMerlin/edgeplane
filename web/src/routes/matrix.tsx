/**
 * Matrix screen — Phase 3 SSE migration.
 *
 * Data source:  SSE /api/events/stream via useEventStream() → Zustand store
 *
 * Parity with web/src/routes/matrix/+page.svelte:
 ...
 *   - Per-event JSON payload expander (details/summary)
 *   - Color-coding by event type (domain/mission/task/agent/error)
 *   - "Show more" pagination (maxVisible cap)
 *   - Clear events action
 *
...
export function MatrixPage() {
  ...
  return (
    <div className="matrix-page" data-testid="matrix-page">
      {/* Filter bar */}
      <div className="matrix-bar" data-testid="matrix-bar">
        <span className="matrix-title">Matrix</span>
