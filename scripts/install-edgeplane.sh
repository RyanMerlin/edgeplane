...
#
# Env overrides:
#   EP_INSTALL_PREFIX, EP_INSTALL_VERSION, EP_INSTALL_NO_DAEMON=1,
#   EP_INSTALL_SERVICE=1, EP_ENV_FILE, EP_INSTALL_SHELL_HOOK=1.
...
INSTALL_DAEMON=1
INSTALL_SERVICE="${EP_INSTALL_SERVICE:-0}"
ENV_FILE="${EP_ENV_FILE:-$ROOT_DIR/.env}"
AUTO_SHELL_HOOK="${EP_INSTALL_SHELL_HOOK:-0}"

[[ "${EP_INSTALL_NO_DAEMON:-0}" = "1" ]] && INSTALL_DAEMON=0
