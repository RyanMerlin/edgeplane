...
//! [`mc_mesh_acp`] client. Every `inject_task` opens a fresh ACP session,
...
use mc_mesh_acp::{Agent, ContentBlock, SessionUpdate, SpawnOpts, consts::PROTOCOL_VERSION, schema};
