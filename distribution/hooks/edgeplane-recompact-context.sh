#!/usr/bin/env sh
# edgeplane-recompact-context.sh — run by Claude Code's SessionStart (compact) hook.
...
CONTEXT_FILE="${EP_INSTANCE_HOME:-$HOME/.edgeplane}/edgeplane/context.json"
...
if [ -f "$CONTEXT_FILE" ]; then
    ...
    echo "No MC context file found — run 'edgeplane set_active_domain' to set your domain."
fi
