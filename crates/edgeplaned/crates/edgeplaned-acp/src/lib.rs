...
//!
//! The crate is intentionally Edgeplane-agnostic. Higher layers
//! (`edgeplaned-runtimes`, `session_supervisor`) wrap it to plug ACP agents
//! into edgeplaned's runtime model.
//!
//! # Layout
//!
