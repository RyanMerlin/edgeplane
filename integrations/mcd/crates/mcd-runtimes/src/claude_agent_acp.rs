...
//! [`mcd_acp`] client. Every `inject_task` opens a fresh ACP session,
...
impl AcpSession {
    ...
    pub fn subscribe_updates(&self) -> tokio::sync::broadcast::Receiver<mcd_acp::wire::SessionNotification> {
