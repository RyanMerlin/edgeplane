...
pub async fn run(command: GovernanceCommand, client: &EdgeplaneClient) -> Result<()> {
    match command {
...
async fn run_roles(command: RolesCommand, client: &EdgeplaneClient) -> Result<()> {
    match command {
...
async fn run_policy(command: PolicyCommand, client: &EdgeplaneClient) -> Result<()> {
    match command {
...
async fn run_events(args: EventsArgs, client: &EdgeplaneClient) -> Result<()> {
