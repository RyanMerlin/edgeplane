...
DO $$ BEGIN ALTER TABLE ONLY public.agent ADD CONSTRAINT agent_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.agentmessage ADD CONSTRAINT agentmessage_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.agentrun ADD CONSTRAINT agentrun_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.agentsession ADD CONSTRAINT agentsession_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.aievent ADD CONSTRAINT aievent_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.aipendingaction ADD CONSTRAINT aipendingaction_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.aisession ADD CONSTRAINT aisession_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.aiturn ADD CONSTRAINT aiturn_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.alembic_version ADD CONSTRAINT alembic_version_pkc PRIMARY KEY (version_num); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.approvalnonceuse ADD CONSTRAINT approvalnonceuse_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.approvalrequest ADD CONSTRAINT approvalrequest_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.artifact ADD CONSTRAINT artifact_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.budgetpolicy ADD CONSTRAINT budgetpolicy_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.budgetwindow ADD CONSTRAINT budgetwindow_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.chatinboundreceipt ADD CONSTRAINT chatinboundreceipt_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.costprofile ADD CONSTRAINT costprofile_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.doc ADD CONSTRAINT doc_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.epic ADD CONSTRAINT epic_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.eventtrigger ADD CONSTRAINT eventtrigger_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.evolvemission ADD CONSTRAINT evolvemission_pkey PRIMARY KEY (mission_id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.evolverun ADD CONSTRAINT evolverun_pkey PRIMARY KEY (run_id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.executionsession ADD CONSTRAINT executionsession_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.feedbackentry ADD CONSTRAINT feedbackentry_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.governancepolicy ADD CONSTRAINT governancepolicy_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.governancepolicyevent ADD CONSTRAINT governancepolicyevent_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.ingestionjob ADD CONSTRAINT ingestionjob_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.joblease ADD CONSTRAINT joblease_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.kluster ADD CONSTRAINT kluster_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.ledgerevent ADD CONSTRAINT ledgerevent_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.meshagent ADD CONSTRAINT meshagent_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.meshmessage ADD CONSTRAINT meshmessage_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.meshprogressevent ADD CONSTRAINT meshprogressevent_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.meshtask ADD CONSTRAINT meshtask_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.meshtaskartifact ADD CONSTRAINT meshtaskartifact_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.mission ADD CONSTRAINT mission_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.missionpack ADD CONSTRAINT missionpack_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.missionpersistencepolicy ADD CONSTRAINT missionpersistencepolicy_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.missionpersistenceroute ADD CONSTRAINT missionpersistenceroute_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.missionrolemembership ADD CONSTRAINT missionrolemembership_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.nodeevent ADD CONSTRAINT nodeevent_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.oidcauthrequest ADD CONSTRAINT oidcauthrequest_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.oidclogingrant ADD CONSTRAINT oidclogingrant_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.overlapsuggestion ADD CONSTRAINT overlapsuggestion_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.publicationrecord ADD CONSTRAINT publicationrecord_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.remotelaunchrecord ADD CONSTRAINT remotelaunchrecord_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.remotetarget ADD CONSTRAINT remotetarget_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.repobinding ADD CONSTRAINT repobinding_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.repoconnection ADD CONSTRAINT repoconnection_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.reviewgate ADD CONSTRAINT reviewgate_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.runcheckpoint ADD CONSTRAINT runcheckpoint_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.runtimejob ADD CONSTRAINT runtimejob_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.runtimejointoken ADD CONSTRAINT runtimejointoken_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.runtimenode ADD CONSTRAINT runtimenode_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.runtimenodespec ADD CONSTRAINT runtimenodespec_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.scheduledagentjob ADD CONSTRAINT scheduledagentjob_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.serviceaccount ADD CONSTRAINT serviceaccount_name_key UNIQUE (name); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.serviceaccount ADD CONSTRAINT serviceaccount_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.serviceaccounttoken ADD CONSTRAINT serviceaccounttoken_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.skillbundle ADD CONSTRAINT skillbundle_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.skilllocalstate ADD CONSTRAINT skilllocalstate_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.skillsnapshot ADD CONSTRAINT skillsnapshot_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.slackchannelbinding ADD CONSTRAINT slackchannelbinding_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.task ADD CONSTRAINT task_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.taskassignment ADD CONSTRAINT taskassignment_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.agentrun ADD CONSTRAINT uq_agentrun_owner_idempotency UNIQUE (owner_subject, idempotency_key); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.costprofile ADD CONSTRAINT uq_costprofile_runtime_provider_model UNIQUE (runtime_kind, provider, model); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.missionpersistencepolicy ADD CONSTRAINT uq_mission_persistence_policy_mission UNIQUE (mission_id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.missionpack ADD CONSTRAINT uq_missionpack_owner_name_version UNIQUE (owner_subject, name, version); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.remotetarget ADD CONSTRAINT uq_remotetarget_owner_name UNIQUE (owner_subject, name); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.repobinding ADD CONSTRAINT uq_repo_binding_owner_name UNIQUE (owner_subject, name); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.repoconnection ADD CONSTRAINT uq_repo_connection_owner_name UNIQUE (owner_subject, name); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.runcheckpoint ADD CONSTRAINT uq_runcheckpoint_run_seq UNIQUE (run_id, seq); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.runtimenode ADD CONSTRAINT uq_runtimenode_name UNIQUE (node_name); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.userprofile ADD CONSTRAINT uq_userprofile_owner_name UNIQUE (owner_subject, name); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.usagerecord ADD CONSTRAINT usagerecord_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.userprofile ADD CONSTRAINT userprofile_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.usersession ADD CONSTRAINT usersession_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.workspacelease ADD CONSTRAINT workspacelease_pkey PRIMARY KEY (id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
...
DO $$ BEGIN ALTER TABLE ONLY public.agentrun ADD CONSTRAINT agentrun_mesh_agent_id_fkey FOREIGN KEY (mesh_agent_id) REFERENCES public.meshagent(id) ON DELETE SET NULL; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.agentrun ADD CONSTRAINT agentrun_mesh_task_id_fkey FOREIGN KEY (mesh_task_id) REFERENCES public.meshtask(id) ON DELETE SET NULL; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.agentrun ADD CONSTRAINT agentrun_parent_run_id_fkey FOREIGN KEY (parent_run_id) REFERENCES public.agentrun(id) ON DELETE SET NULL; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.budgetwindow ADD CONSTRAINT budgetwindow_policy_id_fkey FOREIGN KEY (policy_id) REFERENCES public.budgetpolicy(id) ON DELETE CASCADE; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.meshagent ADD CONSTRAINT meshagent_runtime_node_id_fkey FOREIGN KEY (runtime_node_id) REFERENCES public.runtimenode(id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.meshprogressevent ADD CONSTRAINT meshprogressevent_agent_run_id_fkey FOREIGN KEY (agent_run_id) REFERENCES public.agentrun(id) ON DELETE SET NULL; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.reviewgate ADD CONSTRAINT reviewgate_mesh_task_id_fkey FOREIGN KEY (mesh_task_id) REFERENCES public.meshtask(id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.reviewgate ADD CONSTRAINT reviewgate_run_id_fkey FOREIGN KEY (run_id) REFERENCES public.agentrun(id); EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.runcheckpoint ADD CONSTRAINT runcheckpoint_run_id_fkey FOREIGN KEY (run_id) REFERENCES public.agentrun(id) ON DELETE CASCADE; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.serviceaccounttoken ADD CONSTRAINT serviceaccounttoken_service_account_id_fkey FOREIGN KEY (service_account_id) REFERENCES public.serviceaccount(id) ON DELETE CASCADE; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.usagerecord ADD CONSTRAINT usagerecord_mesh_agent_id_fkey FOREIGN KEY (mesh_agent_id) REFERENCES public.meshagent(id) ON DELETE SET NULL; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.usagerecord ADD CONSTRAINT usagerecord_mesh_task_id_fkey FOREIGN KEY (mesh_task_id) REFERENCES public.meshtask(id) ON DELETE SET NULL; EXCEPTION WHEN OTHERS THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE ONLY public.usagerecord ADD CONSTRAINT usagerecord_run_id_fkey FOREIGN KEY (run_id) REFERENCES public.agentrun(id) ON DELETE SET NULL; EXCEPTION WHEN OTHERS THEN NULL; END $$;