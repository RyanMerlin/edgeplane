...
use mcd_sandbox::types::{CgroupLimits, FsPolicy, NetworkPolicy, SideEffectClass};
use mcd_secrets::types::{CredentialKind, CredentialSource};
...
// ─── Credential deserialization (clix YAML → mcd-secrets types) ──────────
